...
const SplashScreen = lazy(() => import("@/features/splash-screen/SplashScreen"));
...
const AshramaDetails = lazy(() => import("@/features/ashrams/components/AshramDetails"));
const AshramaLive = lazy(() => import("@/features/ashrams/components/AshramLive"));
const AstrologerScreen = lazy(() => import("@/features/astrologer/AstrologerScreen"));
const CalendarScreen = lazy(() => import("@/features/calendar/CalendarScreen"));
const ShubhDinFinder = lazy(() => import("@/features/calendar/components/ShubhDinFinder"));
const ExploreScreen = lazy(() => import("@/features/explore/ExploreScreen"));
const FreeKundliScreen = lazy(() => import("@/features/explore/pages/free-kundli/FreeKundli"));
const GemStoneScreen = lazy(() => import("@/features/explore/pages/gem-stone/GemStone"));
const KundliMatchScreen = lazy(() => import("@/features/explore/pages/kundli-match/KundliMatch"));
const MangalDoshScreen = lazy(() => import("@/features/explore/pages/mangal-dosh/MangalDoshScreen"));
const Numerology = lazy(() => import("@/features/explore/pages/numerology/Numerology"));
const PanchangScreen = lazy(() => import("@/features/explore/pages/panchang/Panchang"));
const TarotReading = lazy(() => import("@/features/explore/pages/tarot-reading/TarotReading"));
const VastuCompassScreen = lazy(() => import("@/features/explore/pages/vastu-compass/VastuCompass"));
...
const WellBeingScreen = lazy(() => import("@/features/well-being/WellBeingScreen"));
const KundliMatchResult = lazy(() => import("@/features/explore/pages/kundli-match/components/KundliMatchResult"));
const MangalDoshResult = lazy(() => import("@/features/explore/pages/mangal-dosh/components/MangalDoshResult"));
const NumerologyResult = lazy(() => import("@/features/explore/pages/numerology/components/NumerologyResult"));
const TarotCards = lazy(() => import("@/features/explore/pages/tarot-reading/components/TarotCards"));
const YesOrNo = lazy(() => import("@/features/explore/pages/tarot-reading/components/YesOrNo"));
const YesOrNoResult = lazy(() => import("@/features/explore/pages/tarot-reading/components/YesOrNoResult"));
const GemStoneResult = lazy(() => import("@/features/explore/pages/gem-stone/components/GemStoneResult"));
